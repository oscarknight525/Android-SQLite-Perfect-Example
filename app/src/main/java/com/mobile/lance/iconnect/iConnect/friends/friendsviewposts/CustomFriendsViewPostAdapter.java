...
import com.mobile.lance.iconnect.iConnect.notification.CustomNotificationsAdapter;
 ...
 */
public class CustomFriendsViewPostAdapter extends BaseAdapter {
    ...
    Bitmap thumbnail;
    Bitmap profileImage;
    public CustomFriendsViewPostAdapter(Activity act, ArrayList<TablePostsItem> friendsviewpost) {
